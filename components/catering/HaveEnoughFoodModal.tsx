        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-scale-in" onClick={e => e.stopPropagation()}>
          ...
          <div className="mb-6">
            <p className="text-center text-gray-600 mb-4">
              Your order covers <strong className="text-[#1A1A1A]">{coverage}%</strong> of {state.headcount} guests
            </p>
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={onContinue}
              className="w-full text-sm text-gray-500 hover:text-[#1A1A1A] transition-colors py-2"
            >
              Continue anyway
            </button>
          </div>
