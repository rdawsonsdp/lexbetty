...
export default function Header() {
  ...
  const navLinks = [
    ...
    { href: '/menus#packages', label: 'CATERING PACKAGES' },
    ...(FEATURES.BETTY_AI_ENABLED ? [{ href: '/concierge', label: 'ASK BETTY' }] : []),
  ];

  return (
    <header className="bg-white text-[#1A1A1A] sticky top-0 z-50 border-b border-gray-100">
          ...
          <nav className="hidden lg:flex items-center gap-5 xl:gap-7 flex-nowrap">
            ...
            <div className="flex items-center gap-3 ml-2">
              <a
                ...
                className="text-[#1A1A1A] hover:text-[#E8621A] transition-colors"
